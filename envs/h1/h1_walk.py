...
from tasks.h1_walking_task import H1WalkingTask

from .gen_xml import *

class H1WalkEnv(mujoco_env.MujocoEnv):
    def __init__(self, path_to_yaml=None):
        ...
        self.task = H1WalkingTask(client=self.interface,
                                  dt=control_dt,
